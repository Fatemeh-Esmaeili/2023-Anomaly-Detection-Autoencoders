...
%Anomaly Detection - Autoencoder BLSTM based
...
hold on
histogram(mse,10,'FaceColor',"#EDB120","DisplayName","Training Set")
...
figName= "AdePredErrorTrainBLSTM.jpg";
figPath = "Data\Image\";
...
histogram(mseTest,2000,"FaceColor","#0000FF","DisplayName","Test Set")
legend
xticklabels(strrep(xticklabels,'-','$-$'));
xlim([-0.01, 0.03])
hold off

figName= "AdePredErrorTestBLSTM.jpg";
figPath = "Data\Image\";
figName = strcat(figPath,figName);
exportgraphics(gcf,figName,'Resolution',1200);
